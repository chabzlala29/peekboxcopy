class User < ActiveRecord::Base
  ...
  has_many :trash_messages_tinbox, :class_name => "UserMessage", :order => "deleted_at DESC", :conditions => ["type_message = ? and status = ?", 'recipient', 'deleted']
  has_many :trash_messages_tsent, :class_name => "UserMessage", :order => "deleted_at DESC", :conditions => ["type_message = ? and status = ?", 'sender', 'deleted']
